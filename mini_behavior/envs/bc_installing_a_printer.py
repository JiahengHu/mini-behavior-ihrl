...
class BCSimpleInstallingAPrinterEnv(InstallingAPrinterEnv):
    """
    ...
    def __init__(
        ...
        self.actions = BCSimpleInstallingAPrinterEnv.Actions
...
register(
    ...
    entry_point='mini_behavior.envs:BCSimpleInstallingAPrinterEnv'
)
...
class SimpleInstallingAPrinterDistractEnv(BCSimpleInstallingAPrinterEnv):
    """
    Environment in which the agent is instructed to install a printer
    """
